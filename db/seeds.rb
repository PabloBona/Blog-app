...
first_user = User.create('name' => 'Linda', 'photo' => 'https://i.pravatar.cc/150?img=12', 'bio' => 'Linda is a prominent scientist in the field of biotechnology. Born in New York in 1980, Ana showed exceptional talent from a young age. She completed her Ph.D. in Molecular Genetics at the age of 25 and has since been a trailblazer in researching gene therapies for rare diseases. Her commitment to gender equity in science has led her to spearhead mentorship programs for young women in STEM.')
second_user = User.create('name' => 'Ana', 'photo' => 'https://i.pravatar.cc/150?img=14', 'bio' => 'Ana is a renowned Spanish architect born in Barcelona in 1975. Her passion for sustainable architecture has led her to design iconic buildings that combine modern aesthetics with eco-efficiency. Maria has received numerous awards for her work and is a passionate advocate for revitalizing urban spaces through sustainable design.')
third_user = User.create('name' => 'George', 'photo' => 'https://i.pravatar.cc/150?img=10', 'bio' => 'George is a chef and culinary entrepreneur hailing from South Korea. Born in Seoul in 1981, Chang moved to New York in his teens and revolutionized the culinary scene with his restaurant, Momofuku. His innovative approach to cuisine blends traditional techniques with global influences, earning multiple Michelin stars and transforming how we perceive Asian food.')
fourth_user = User.create('name' => 'Ringo', 'photo' => 'https://i.pravatar.cc/150?img=18', 'bio' => 'Ringo is a successful Argentinean entrepreneur born in Buenos Aires in 1970. He began his career as a tech entrepreneur in the 1990s and founded several market-leading technology companies. His strategic vision and leadership have made him a stalwart in the international tech industry. Additionally, he is known for his commitment to corporate social responsibility and philanthropy.')
